...
public class A_EntityLifeCycleTRD {
    ...
    * 영속 : 영속 상태의 엔티티는 영속성 컨텍스트에 의해 관리되고, 데이터베이스와 동기화한다.
    ...
    * */
    ...
    public void test1() {
        ...
        // then
        // 영속성 컨텍스트는 관리되고 있는 내용이 동일한 내용이라면, 주소값이 같아아ㅑ 한다.
    ...
    public void test2() {
        /*
        * 엔티티 매니저가 영속성 컨텍스트에 엔티티 객체를 저장(persisf)하면 영속성 컨텍스트가 엔티티 객체를 관리하게 되고 이를 영속 상태라고 한다.
        * find(), JPQL을 사용한 조화도 영속상태가 된다.
        * */
        // given
