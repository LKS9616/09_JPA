...
public class BiDirectionTests {
    ...
    /*
    * 데이터베이스 테이블은 외래키 하나로 양방향 조회가 가능하지만, 객체는 서로 다른 두 단방향 참조를 합쳐서 양방향이라고 한다.
    ...
    * */
    ...
    public void test1() {
        ...
        // toString() 오버라이딩 또는 lombok을 사용하면 일방향 연관관계에서는 재귀호출이 일어나기 때문에 stackOverFlow 발생!
