...
public class ProjectionTests {
    ...
    *
    * 4. new 명령어를 활용한 프로젝션
    *    - 다양한 종류의 단순 값을들 DTO로 조회하는 방식 (new 패키지명.DTO명)
    *    -> new 사용해서 만들기 때문에 기본 생성자가 필요하다.
    ...
    * */
    ...
    void test2() {
        ...
        BiDirectionCategory category = entityManager.createQuery(jpql, BiDirectionCategory.class).setParameter("menucode", menuCodeParameter).getSingleResult();
    ...
    void test5() {
        ...
        List<Object[]> categoryNameList = entityManager.createQuery(jpql).getResultList();
